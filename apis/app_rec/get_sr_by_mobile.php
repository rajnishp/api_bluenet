...
$sql = "SELECT sr.id, service,service_type,salary,start_time,end_time,"
    ...
    . "LEFT JOIN `bluenet_v3`.timings AS t "
    . "LEFT JOIN `bluenet_v3`.worker_customer_match AS wcm "
    . "LEFT JOIN `bluenet_v3`.ratings AS r "
    . "LEFT JOIN `bluenet_v3`.ratings AS wr "
    . "LEFT JOIN `bluenet_v3`.users AS u "
    . "LEFT JOIN `bluenet_v3`.users AS uw "
    . "WHERE sr.mobile = '" . $route[2]  ."' "
